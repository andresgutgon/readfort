...
import { Alert, AlertDescription, AlertTitle, Button } from '@readfort/ui'
...
function IncompleNotesAlert() {
  return (
    <Alert variant='warning'>
      ...
      <AlertDescription>
        Some notes are not complete. This happens some times depending on the
        book and the amount of notes you took.
      </AlertDescription>
    </Alert>
  )
}
...
function ImportHighlightsButton() {
  ...
  return (
    <Button onClick={onClickGenerate} variant='default'>
